...
public class JogoDicionarioActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_jogo_dicionario);
	...
	private OnClickListener botaoSairListener() {
		return new OnClickListener() {
			...
			public void onClick(View v) {
				Intent botaoSairIntent = new Intent(JogoDicionarioActivity.this, 
